    ...
    <div style={{padding: '5%'}} className='w-full flex flex-col items-center justify-center'>
      <div className='w-3/4 flex flex-col gap-10 items-center justify-center'>
        ...
        <div className='flex flex-col items-center justify-center gap-4'>
          <h1 className='text-[24px] font-bold text-[#191C1F]'>Your order is successfully placed</h1>
          <p className='md:w-3/4 text-center text-[#5F6C72] text-[14px]'>Your order <span className='font-bold'>{orderId}</span> has been placed successfully, visit your dashboard to track your order progress</p>
