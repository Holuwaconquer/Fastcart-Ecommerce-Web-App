  ...
  return (
    <div style={{padding: '3%'}} className='w-full flex flex-col gap-4 items-center justify-center'>
      <DotLottieReact
        ...
        className='w-2/4'
      />
      <h1 className='font-bold text-[#191C1F] text-[36px]'>404, Page not found</h1>
      <p className='text-[16px] text-center text-[#475156] w-2/4'>Something went wrong. It’s look that your requested could not be found. It’s look like the link is broken or the page is removed.</p>
